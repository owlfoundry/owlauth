...
06. Auth and Control use distinct listeners. Within Auth, Runtime Project Auth and Server API use distinct routers, state, authentication policies, admission, PostgreSQL pools, readiness inputs, and OpenAPI contracts.
