...
| [`07-cli-and-mcp-boundaries.md`](07-cli-and-mcp-boundaries.md) | deployment-operator Control trust, CLI/MCP adapters, `belongs_to`, and external gateway boundaries |
