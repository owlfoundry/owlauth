...
- never enters Runtime/Server API/Control DTOs, user projections, webhook payloads, redirects, logs, audit safe context, Redis, or an Application process;
...
03. provider tokens cannot appear in any Runtime/Server API/Control DTO, Application projection/webhook, redirect, Redis value, log, audit safe context, or browser asset/configuration;
