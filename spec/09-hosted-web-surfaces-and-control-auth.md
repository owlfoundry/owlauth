...
| Route class | Purpose |
| --- | --- |
| `<runtime-base>/auth/interactions/{opaque_handle}` | render or continue one bounded Project/Application method-selection/provider/email/OTP interaction |
...
| `<runtime-base>/v1/projects/{project_id}/auth/*` | Runtime Project Auth API, including generic login start, transaction method selection, method-specific proof/callback, handoff, session, and logout operations |
