...
docker run --detach \
  ...
  --env OWLAUTH_AUTH_PROCESS_ID=smoke-auth \
  --env OWLAUTH_REQUIRED_AUTH_PROCESS_IDS=smoke-auth \
  --env OWLAUTH_SERVER_KEY_DIGEST_KEY_VERSION=1 \
  --env OWLAUTH_SERVER_KEY_DIGEST_KEY=WlpaWlpaWlpaWlpaWlpaWlpaWlpaWlpaWlpaWlpaWlo \
  "$image" >/dev/null
